...
namespace HotelManager
{
    public partial class fParameter : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("Do you want an update?", "Question", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
        ...
        private void ToolStripLabel1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show( "Please Install MS Office", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private void UpdateSurcharge()
        {
            ...
            {
                MessageBox.Show( "Cannot Update, provide all details first", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
            ...
            if (isFill)
            {
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show( "No data has been changed", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                    else
                    {
                        ...
                        if (check)
                        {
                            ...
                            MessageBox.Show("Cannot update (No surcharge)", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    }
                }
                catch
                {
