...
namespace HotelManager.DTO
{
    public class Customer
    {
        ...
        public Customer(int id,string idCard, string name, int idcustomerType, string address, string email, string city, string phoneNumber, string sex, string nationality,DateTime dateOfBirth)
        {
            this.Id = id;
            this.IdCard = idCard;
            this.Name = name;
        ...
        public bool Equals(Customer customerPre)
        {
            ...
            if(this.email != customerPre.email) return false;
            if(this.city != customerPre.city) return false;
            return true;
        }
