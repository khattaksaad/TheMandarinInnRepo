...
namespace HotelManager
{
    public partial class fRoomType : Form
    {
        ...
        private void UpdateRoomType()
        {
            if(comboboxID.Text == string.Empty)
            {
                MessageBox.Show("This room type does not exist yet", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            else
            if (!fCustomer.CheckFillInText(new Control[] { txbName, txbPrice }))
            {
                MessageBox.Show( "Pleae provide all the details first", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            else
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if(check)
                        {
                            ...
                            MessageBox.Show( "Unknown error occurred", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    }
                }
                catch
                {
