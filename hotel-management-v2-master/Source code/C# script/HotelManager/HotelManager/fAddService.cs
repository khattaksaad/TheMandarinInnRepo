...
namespace HotelManager
{
    public partial class fAddService : Form
    {
        ...
        private void InsertService()
        {
            ...
            {
                DialogResult result = MessageBox.Show("Cannot be left blank", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            try
            {
        ...
        {
            DialogResult result = MessageBox.Show("Do you want to add new services?", "Question", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
