...
namespace HotelManager
{
    public partial class fAddStaff : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("Do you want to add new staff member?", "Question", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
        ...
        private void InsertStaff()
        {
            ...
            if (isFill)
            {
                ...
                {
                    MessageBox.Show("An unknown error", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
                MessageBox.Show("Fill all details first", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private bool CheckDate()
        {
            ...
            {
                MessageBox.Show("Invalid date of birth (Age must be greater than 18)", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            else
