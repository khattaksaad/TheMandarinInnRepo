...
namespace HotelManager
{
    public partial class fBookRoom4Self : Form
    {
        ...
        public void InsertBookRoom(int roomId, int idCustomer, int idRoomType, int bookingType, string roomName, DateTime datecheckin, DateTime datecheckout, DateTime datebookroom, int priceChargedPerNight, string userId)
        {
            BookRoomDAO.Instance.InsertBookRoom(roomId, idCustomer, idRoomType, bookingType, roomName, datecheckin, datecheckout, datebookroom, priceChargedPerNight, this.userName);
        }
