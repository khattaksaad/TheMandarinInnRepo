...
namespace HotelManager.DAO
{
    public class ReceiveRoomDAO
    {
        ...
        public bool InsertReceiveRoom(int idBookRoom, int idRoom, string userName)
        {
            string query = "InsertReceiveRoom @idBookRoom , @idRoom , @userName";
            int count = DataProvider.Instance.ExecuteNoneQuery(query, new object[] { idBookRoom, idRoom, userName });
            return count > 0;
        }
