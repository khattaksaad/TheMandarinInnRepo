...
namespace HotelManager
{
    public partial class fUpdateCustomerInfo : Form
    {
        ...
        public void UpdateCustomer()
        {
            ...
            CustomerDAO.Instance.UpdateCustomer(CustomerDAO.Instance.GetInfoByIdCard(idCard).Id,txbFullName.Text, txbID.Text,idCustomerType,txbPhoneNumber.Text, txbEmail.Text, txbCity.Text,dpkDateOfBirth.Value,txbAddress.Text,cbSex.Text,cbNationality.Text);
        }
        public void ClearData()
        {
            txbID.Text = txbFullName.Text = txbAddress.Text = txbPhoneNumber.Text = cbNationality.Text = txbEmail.Text = txbCity.Text= String.Empty ;
        }
